...
export const about = {
  bio: '拥有 <strong>8 年互联网行业经验</strong>的资深前端工程师，先后服务于多家互联网企业和医疗健康公司。目前在<span class="highlight">老百姓大药房</span>担任前端负责人，带领 5-6 人团队，主导了医药电商小程序、互联网医院、远程审方系统、医保合规管理系统等多个核心项目的<span class="highlight">架构设计与落地实施</span>。技术栈覆盖 Vue2/3、微信小程序原生、TypeScript，具备从 0 到 1 搭建完整前端体系的能力。项目经验涵盖跨端开发（小程序 / H5 / PC）、复杂业务状态机设计、实时音视频通信、医保支付对接等领域。',
  cards: [
...
export const experiences: Experience[] = [
  {
    ...
    period: '2021.03 - 至今',
    description: '担任前端负责人，带领 5-6 人前端团队，负责公司核心业务系统的架构设计、技术选型与交付落地。',
    achievements: [
  ...
  },
  {
    ...
    description: '负责互联网医疗产品线前端开发，主导 EPS 远程审方系统重构，从 Thymeleaf + Layui 服务端渲染迁移为 Vue2 SPA 架构。',
    achievements: [
...
export const projects: Project[] = [
  {
    ...
    intro: '从 0 到 1 主导开发的医药电商微信小程序，服务于老百姓大药房连锁药房体系（覆盖 18+ 子品牌），承载在线购药、互联网医院复诊开方、医保支付、全球购跨境商城、会员储值卡、分销直播等全链路业务。项目规模：14 个分包、200+ 页面、25+ API 模块、60+ 公共组件。',
  ...
  },
  {
    ...
    role: '前端负责人（整体项目负责人）',
    intro: '老百姓大药房医保业务的合规管理中枢，覆盖 9 类医保规则（诊断/提示/数量/金额/年龄/性别/周期/通用/门店）的全生命周期管理（创建→配置→关联→启停→导出）。系统通过规则配置引擎实现灵活配置，通过合理用药模块对处方进行合规审核，通过调用日志模块实现操作可追溯，支撑全国 5000+ 门店的医保合规运营。',
  ...
  },
  {
    ...
    role: '前端负责人',
    intro: '老百姓大药房处方流转的后台管理中枢，负责管理全国数千家门店与互联网医院的对接配置、处方流转状态追踪、审方规则控制和药品合规管理。系统覆盖 POS 终端、百姓通 APP、小程序三端渠道，是"线上问诊→电子处方→门店取药"闭环的核心配置层。',
  ...
  },
  {
    ...
    period: '2019 - 至今',
    role: '前端负责人 & 核心开发',
    intro: '老百姓大药房旗下互联网医院微信小程序，为用户提供在线问诊（图文/视频/AI 三种模式）、电子处方、药品购买一站式服务。用户从商城小程序跳入，经过门店解析、医生选择、问诊提交、在线支付、诊室交互（图文聊天/AI 问卷/视频跳转），最终获取处方并完成购药闭环。对接 4 家医疗服务供应商（华夏/智云/泰康/平安），每家有独立的接入方式、字段校验规则和实名认证要求。',
  ...
  },
  {
    ...
    period: '2019 - 2021',
    role: '前端负责人（架构迁移主导）',
    intro: '连锁药房合规要求：处方药销售必须经执业药师审核。原系统基于 Thymeleaf + Layui 服务端渲染架构，维护成本高、用户体验差、无法支持实时音视频审方。我主导了前端架构迁移方案设计，将服务端渲染迁移为 Vue 2 SPA，覆盖全国 4 省门店的处方审核、远程视频问诊、调配发药全流程。',
  ...
  },
  {
    ...
    period: '2024 - 至今',
    role: '核心开发（第 3 高贡献者）',
    intro: '为连锁药店店员提供的移动端处方流转工作台，内嵌于百姓通原生 App 中运行。涵盖开具处方、AI 拍照识别处方、药师审方、人工调配、复核发药、电子签章、凭证管理、视频问诊等全流程功能。项目规模：102 个 Vue 文件 + 56 个 TS 文件，3.3MB / 32,593 行代码。',
...
export const navItems = [
  ...
  { id: 'about', label: '关于我', num: '02' },
  { id: 'experience', label: '工作经历', num: '03' },
  { id: 'skills', label: '技能', num: '04' },
  { id: 'projects', label: '项目经历', num: '05' },
  { id: 'contact', label: '联系方式', num: '06' },
]
